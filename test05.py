...
def region_of_interest(r_image):
    ...
    poly = np.array([
                    #[(0, h), (470, h), (280, 80), (170, 80)] #a01.jpg
                    [(0, h), (790, h), (400, 300), (200, 300)] #a02.jpg
                    ])
...
if __name__ == '__main__':
    ...
    lines = cv2.HoughLinesP(cropped_image, 1, np.pi / 180, 15, np.array([]), minLineLength=20, maxLineGap=50)
    ...
    lefttop = clac_edgepoints(leftpoints, 350, image.shape[0]) # 要畫左右車道線的端點
    righttop = clac_edgepoints(rightpoints, 350, image.shape[0])
