...
def region_of_interest(r_image):
    ...
    poly = np.array([
                    [(120, h), (530, h), (305, 150), (260, 150)] #a02.jpg
                    ])
...
if __name__ == '__main__':
    mp4 = cv2.VideoCapture('car_2.mp4')
    while(True):
        ret,image = mp4.read()
        if ret:
            try:
                ...
                cv2.line(src, lefttop[0], lefttop[1], (0, 128, 255), 7)
                cv2.line(src, righttop[0], righttop[1], (128, 255, 0), 7)
